...
- The comprehensive general gameplay rules are documented in the in-app rulebook at `components/RulebookModal.tsx`. Use that file as the primary summary reference for turn flow, deployment, combat, logistics, neutral creeps, and victory conditions before restating game rules elsewhere.
