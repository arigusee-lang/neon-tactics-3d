...
const UnitControlPanel: React.FC<UnitControlPanelProps> = ({ unit, isDevMode }) => {
  // Draggable State
  ...
  const mainColor = isP1 ? COLORS.P1 : COLORS.P2;
                    ...
                    <div className="flex flex-col">
                        ...
                        {unit.type === UnitType.MEDIC && (
                            <AbilityButton 
                                ...
                                icon="+"
                                cost={25}
                                description="Heal friendly unit within 2 tiles for 50 HP."
                        ...
                        {unit.type !== UnitType.HEAVY && unit.type !== UnitType.CONE && unit.type !== UnitType.SOLDIER && unit.type !== UnitType.SUICIDE_DRONE && unit.type !== UnitType.MEDIC && unit.type !== UnitType.TITAN && unit.type !== UnitType.CHARGING_STATION && !isDevMode && (
