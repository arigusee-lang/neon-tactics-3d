...
const MapEditor: React.FC<MapEditorProps> = ({ activeTool }) => {
    ...
    const baseIconClass = 'w-5 h-5 fill-none stroke-current stroke-2';
    ...
    const tools: { id: TerrainTool, label: string, icon: React.ReactNode }[] = [
        ...
        },
        {
            ...
            label: 'Delete',
            icon: (
                <svg viewBox="0 0 24 24" className={`${baseIconClass} text-red-500`}>
        ...
        },
        {
            ...
            label: 'HP (+75)',
            icon: (
                <svg viewBox="0 0 24 24" className={`${baseIconClass} text-green-500`}>
        ...
        },
        {
            ...
            label: 'Energy (+50)',
            icon: (
                <svg viewBox="0 0 24 24" className={`${baseIconClass} text-purple-400`}>
    ...
    return (
        ...
        >
            ...
            <div className={`flex flex-col flex-1 min-h-0 ${isMinimized ? 'hidden' : 'flex'}`}>
                <div className="p-3 overflow-y-auto game-scrollbar flex-1">
                        ...
                        {tools.map(tool => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center w-full min-h-[3.2rem] rounded border px-1 py-1.5 transition-all duration-200 group
                                        ${isActive
                                ...
                                >
                                    ...
                                    <span className="text-[8px] font-bold uppercase text-center leading-[1.05] px-0.5">{tool.label}</span>
                                </button>
                            );
                        })}
                    </div>
